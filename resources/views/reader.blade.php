	...
	<div id='base_elements'>
		<div id='content_box' class='text_scroll_box' style="position:absolute;top:-10%;">
			<div id='text_scroll_area' class='text_scroll' align='left' >
				<em id="file_title" style="font-style:normal;top:-5vh; left:1.7vw;position:relative;"> </em>
				<div id='text_from_file' class='reader_text' style="top:-5vh;"> </div>
			</div>
		</div>
		<div id="zoom_box" class="text_zoom_box">
			<div id="reader_zoom" class="text_zoom"> </div>
		</div>
